...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID = "pe/my.groupId";

  Config() {
    config = SpConfig.getSpConfig(SERVICE_ID);

    config.register(ConfigKeys.HOST, "my-source", "Hostname for the pe source component");
    ...
    config.register(ConfigKeys.SERVICE_NAME, "mypackagename", "The name of the service");
